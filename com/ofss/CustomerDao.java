...
public class CustomerDao {
    ...
    public int deleteById(int id) {
        ...
        int customerRows = jdbcTemplate.update("DELETE FROM CUSTOMERS WHERE CUST_ID = ?", id);
        // Delete from USERS
        int userRows = jdbcTemplate.update("DELETE FROM USERS WHERE USER_ID = ?", id);
        // Return total rows affected (both tables)
