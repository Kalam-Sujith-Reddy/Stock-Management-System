...
public class StockDAO {
    ...
    public int save(Stock s) {
        return jdbcTemplate.update(
            "INSERT INTO STOCKS (STOCK_ID, STOCK_NAME, STOCK_PRICE, STOCK_VOLUME, LISTING_PRICE, LISTED_DATE, LISTED_EXCHANGE) VALUES (?, ?, ?, ?, ?, ?, ?)",
            s.getStockId(), s.getStockName(), s.getStockPrice(), s.getStockVolume(), s.getListingPrice(),
            new Date(s.getListedDate().getTime()), s.getListedExchange()
        );
    }
